...
public class Project_item implements Serializable {
    ...
    private boolean have_action;
    public Project_item(int id, int user_id, int status_code, int created_by_id, int assigned_to, String status_message, String client_company, String project_name, String client_name, String project_country, String project_timeline, String created_at, String created_by, boolean have_action) {
        this.id = id;
