...
public class Extras_adapter extends RecyclerView.Adapter<Extras_adapter.ViewHolder> {

    private final List<Extras_item> items;

    private final Context mContext;
    private final AdapterCallback mAdapterCallback;

    public Extras_adapter(Context context, ArrayList<Extras_item> items) {
    ...
    @NonNull
    @Override
    public Extras_adapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_request_extras, parent, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull Extras_adapter.ViewHolder holder, final int position) {
