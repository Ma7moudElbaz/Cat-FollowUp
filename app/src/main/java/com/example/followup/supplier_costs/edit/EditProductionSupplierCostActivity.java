...
public class EditProductionSupplierCostActivity extends LocalizationActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_edit_production_supplier_cost);
        initFields();
    ...
    private void showDatePicker(TextView textview) {
        ...
        // date picker dialog
        picker = new DatePickerDialog(EditProductionSupplierCostActivity.this,
    ...
    private boolean validateFields() {
        ...
        if (storage.length() == 0) {
            storage.setError("This is required field");
            return false;
        }
        return true;
    }
