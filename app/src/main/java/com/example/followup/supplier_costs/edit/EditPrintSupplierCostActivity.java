...
public class EditPrintSupplierCostActivity extends LocalizationActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_edit_print_supplier_cost);
    ...
    private void showDatePicker(TextView textview) {
        ...
        // date picker dialog
        picker = new DatePickerDialog(EditPrintSupplierCostActivity.this,
    ...
    private void setFields(JSONObject dataObj) throws JSONException {
        ...
        printing_type.setText(StringCheck.returnEmpty(costObj.getString("print_type")));
